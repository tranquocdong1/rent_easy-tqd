          ...
          <table className="w-full text-left table-fixed min-w-[1050px]">
            <thead>
              <tr className="text-slate-500 border-b border-slate-200/90 font-bold text-xs uppercase tracking-wider">
                <th className="w-[13%] pb-4 pr-4 whitespace-nowrap">Mã Biên lai</th>
                <th className="w-[13%] pb-4 px-3 whitespace-nowrap">Mã Hóa đơn</th>
                <th className="w-[15%] pb-4 px-3 whitespace-nowrap">Khách thuê</th>
                <th className="w-[17%] pb-4 px-3 whitespace-nowrap">Phòng / Khu trọ</th>
                <th className="w-[13%] pb-4 px-3 whitespace-nowrap">Ngày thanh toán</th>
                <th className="w-[12%] pb-4 px-3 text-right whitespace-nowrap">Số tiền</th>
                <th className="w-[13%] pb-4 px-3 whitespace-nowrap">Phương thức</th>
                <th className="w-[11%] pb-4 pl-3 whitespace-nowrap">Trạng thái</th>
              </tr>
            </thead>
            <tbody
